...
jQuery(document).ready(function() {
	$("#newsletter-form").submit(function() {
		...
		$.ajax({
			type: "POST",
			url: "contact_form/newsletter_process.php",
			data: str,
			success: function(msg) {
				// Message Sent - Show the 'Thank You' message and hide the form
				if(msg == 'OK') {
...
//ATTR DATA
jQuery(document).ready(function() {
	jQuery('.menu_block').find('.nav li a').not('li li a').each(function(){
		jQuery(this).attr("data-hover", $(this).text());
	});
});
...
jQuery(window).load(function(){
	...
	jQuery('.owl-next').addClass('fe arrow_carrot-right');
	jQuery('.owl-prev').addClass('fe arrow_carrot-left');
...
$(document).ready(function() {
    ...
    || (navigator.userAgent.match(/iPad/i))) {
        $('.project_item').bind('mouseenter', function(e) {
            $(this).find('.recent_projects_descr').show();
            $(this).find('.recent_projects_descr').css('visibility','visible');
        });
        $('.project_item').bind('mouseleave', function(e) {
            $(this).find('.recent_projects_descr').hide();
        });
    }
});
